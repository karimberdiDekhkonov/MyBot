...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="MyBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" uz.pdp.Main %CMD_LINE_ARGS%
